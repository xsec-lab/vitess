...
package tabletmanagerdata // import "github.com/xsec-lab/vitess/go/vt/proto/tabletmanagerdata"

import proto "github.com/golang/protobuf/proto"
import fmt "fmt"
import math "math"
import logutil "github.com/xsec-lab/vitess/go/vt/proto/logutil"
import query "github.com/xsec-lab/vitess/go/vt/proto/query"
import replicationdata "github.com/xsec-lab/vitess/go/vt/proto/replicationdata"
import topodata "github.com/xsec-lab/vitess/go/vt/proto/topodata"
...
var fileDescriptor_tabletmanagerdata_7a10c2dfddcc994f = []byte{
	...
	,
}
