...
echo "\
  ...
  -X 'github.com/xsec-lab/go/vt/servenv.buildGitRev=$(git rev-parse --short HEAD)' \
  -X 'github.com/xsec-lab/go/vt/servenv.buildGitBranch=$(git rev-parse --abbrev-ref HEAD)' \
